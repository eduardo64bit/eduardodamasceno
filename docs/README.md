...
| [migrate-from-supabase.md](./migrate-from-supabase.md) | Migração histórica Supabase → SQLite |
| [legacy-supabase/](./legacy-supabase/) | Schema Postgres arquivado (não usado) |
